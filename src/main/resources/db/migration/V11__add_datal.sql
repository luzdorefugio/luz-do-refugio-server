...
INSERT INTO products (
    ...
    featured
      ...
      (
          ...
          'VEL_AMBROSIA',
          12,
          'Feche os olhos e viaje para um paraíso tropical. Uma explosão de alegria liderada pela manga suculenta ao lado da papaia, com um fundo surpreendente de baunilha e canela que transforma a frescura frutada numa fragrância envolvente.',
          NOW(), 'MIGRATION', '± 35 Horas', 4,
          'Manga, laranja, limão',
          'Manga, Papaia, frutas vermelhas',
          'Baunilha, canela',
      ...
      (
          ...
          NULL, NULL, NULL,
          'Entre o quente indulgente da Pistacho Royal e o doce envolvente da Coração de Luz, encontrámos o equilíbrio perfeito para iluminar os vossos momentos a dois.',
